...
export function TaskItem({ id, title, status, onToggleStatus, onDelete, isCreator }: TaskItemProps) {
  ...
  return (
    <div className="flex items-center justify-between rounded-lg bg-muted p-3 shadow-sm transition-shadow hover:shadow-md">
      ...
      {isCreator && (
        <Button variant="ghost" size="icon" onClick={handleDelete} disabled={isPending} aria-label="Remove task">
