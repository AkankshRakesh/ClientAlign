    ...
    return (
      <Sidebar>
        <SidebarHeader className="border-b border-purple-200/50 dark:border-purple-800/30 bg-gradient-to-r from-purple-50/30 to-pink-50/30 dark:from-purple-900/20 dark:to-pink-900/20">
          <SidebarMenu>
            <SidebarMenuItem>
              <SidebarMenuButton asChild className="hover:bg-gradient-to-r hover:from-purple-100/50 hover:to-pink-100/50 dark:hover:from-purple-800/30 dark:hover:to-pink-800/30 transition-all duration-300">
                <Link href="/">
                  ...
                  <span className="font-semibold bg-gradient-to-r from-purple-600 to-pink-600 bg-clip-text text-transparent">ClientAlign</span>
                </Link>
              </SidebarMenuButton>
            </SidebarMenuItem>
          </SidebarMenu>
        ...
        <SidebarContent>
          <SidebarGroup>
            ...
            <SidebarGroupContent>
              <SidebarMenu>
                <SidebarMenuItem>
                  <SidebarMenuButton asChild className="hover:bg-gradient-to-r hover:from-green-50/50 hover:to-emerald-50/50 dark:hover:from-green-900/20 dark:hover:to-emerald-900/20 transition-all duration-300">
                    <Link href="/login">
                ...
                <SidebarMenuItem>
                  <SidebarMenuButton asChild className="hover:bg-gradient-to-r hover:from-blue-50/50 hover:to-cyan-50/50 dark:hover:from-blue-900/20 dark:hover:to-cyan-900/20 transition-all duration-300">
                    <Link href="/signup">
      ...
      <SidebarContent>
        <SidebarGroup>
          ...
          <SidebarGroupContent>
            <SidebarMenu>
              ...
              <SidebarMenuItem>
                <SidebarMenuButton asChild className="hover:bg-gradient-to-r hover:from-purple-50/50 hover:to-pink-50/50 dark:hover:from-purple-900/20 dark:hover:to-pink-900/20 transition-all duration-300">
                  <Link href="/projects">
              ...
              <SidebarMenuItem>
                <SidebarMenuButton asChild className="hover:bg-gradient-to-r hover:from-orange-50/50 hover:to-red-50/50 dark:hover:from-orange-900/20 dark:hover:to-red-900/20 transition-all duration-300">
                  <Link href="#">
              ...
              <SidebarMenuItem>
                <SidebarMenuButton asChild className="hover:bg-gradient-to-r hover:from-indigo-50/50 hover:to-blue-50/50 dark:hover:from-indigo-900/20 dark:hover:to-blue-900/20 transition-all duration-300">
                  <Link href="#">
        ...
        <SidebarGroup>
          ...
          <SidebarGroupAction asChild>
            <Button variant="ghost" size="icon" className="size-5 hover:bg-gradient-to-r hover:from-purple-100/50 hover:to-pink-100/50 dark:hover:from-purple-900/30 dark:hover:to-pink-900/30 transition-all duration-300">
          ...
          <SidebarGroupContent>
            <SidebarMenu>
              ...
              <SidebarMenuItem>
                <SidebarMenuButton asChild className="hover:bg-gradient-to-r hover:from-blue-50/50 hover:to-purple-50/50 dark:hover:from-blue-900/20 dark:hover:to-purple-900/20 transition-all duration-300">
        ...
        <SidebarMenu>
          <SidebarMenuItem>
            <DropdownMenu>
              ...
              <DropdownMenuContent side="top" className="w-[--radix-popper-anchor-width] bg-white/95 dark:bg-gray-900/95 backdrop-blur-md border border-purple-200/50 dark:border-purple-800/30">
                <DropdownMenuItem asChild className="hover:bg-gradient-to-r hover:from-purple-50/50 hover:to-pink-50/50 dark:hover:from-purple-900/30 dark:hover:to-pink-900/30">
                  <Link href="/projects">
                    <span>Account</span>
                  </Link>
                </DropdownMenuItem>
                ...
                <DropdownMenuItem onClick={handleSignOut} className="hover:bg-gradient-to-r hover:from-red-50/50 hover:to-pink-50/50 dark:hover:from-red-900/30 dark:hover:to-pink-900/30">
                  <span>Sign out</span>
                </DropdownMenuItem>
              </DropdownMenuContent>
            </DropdownMenu>
