...
export default function Home() {
  ...
  useEffect(() => {
    ...
    const ctx = gsap.context(() => {
      ...
      // Features section animations with stagger
      gsap.fromTo(
        ".feature-card",
      ...
      // Benefits section animations with stagger
      gsap.fromTo(
        ".benefit-item",
        { opacity: 0, x: -50 },
        {
    ...
    <div className="relative min-h-screen overflow-hidden bg-gradient-to-br from-slate-50 via-white to-blue-50">
      ...
      <section ref={heroRef} className="relative z-10 px-4 pt-20 pb-32">
        <div className="container mx-auto text-center">
          ...
          <div className="floating-1 absolute top-20 left-10">
            <div className="h-16 w-16 rotate-12 rounded-2xl bg-gradient-to-br from-blue-400 to-purple-400 opacity-20 shadow-lg"></div>
          </div>
          <div className="floating-2 absolute top-40 right-20">
            <div className="h-12 w-12 rounded-full bg-gradient-to-br from-purple-400 to-pink-400 opacity-30 shadow-md"></div>
          </div>
          <div className="floating-3 absolute bottom-20 left-1/4">
            <div className="h-8 w-8 rotate-45 rounded-lg bg-gradient-to-br from-cyan-400 to-blue-400 opacity-25 shadow-sm"></div>
          </div>

          {/* Additional floating shapes */}
          <div className="floating-4 absolute top-32 right-1/3">
            <div className="h-6 w-6 rounded-full bg-gradient-to-br from-yellow-400 to-orange-400 opacity-25"></div>
          </div>
          <div className="floating-5 absolute right-10 bottom-40">
            <div className="h-10 w-10 rotate-12 rounded-xl bg-gradient-to-br from-green-400 to-teal-400 opacity-20"></div>
          </div>
          <div className="floating-6 absolute top-1/2 left-20">
            <div className="h-14 w-14 rotate-45 transform rounded-2xl bg-gradient-to-br from-indigo-400 to-purple-400 opacity-15"></div>
          </div>

          {/* Geometric shapes with unique animations */}
