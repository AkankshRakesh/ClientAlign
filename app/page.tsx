      ...
      {user ? (
        ...
        <div className="mt-8 flex flex-col items-center gap-4 animate-in fade-in-50 slide-in-from-bottom-10 duration-1000 delay-600">
          <div className="p-6 rounded-2xl bg-gradient-to-br from-purple-50/80 to-pink-50/80 dark:from-purple-900/20 dark:to-pink-900/20 backdrop-blur-sm border border-purple-200/50 dark:border-purple-800/50">
            <p className="text-muted-foreground mb-4">
              Welcome back, <span className="font-semibold text-purple-600 dark:text-purple-400">{user.user_metadata?.full_name || user.email?.split('@')[0] || 'User'}</span>!
            </p>
            <div className="flex gap-4">
              ...
              <Button variant="outline" size="lg" asChild className="border-purple-300 text-purple-700 hover:bg-purple-50 dark:border-purple-700 dark:text-purple-300 dark:hover:bg-purple-900/20 transition-all duration-300">
        ...
        <div className="mt-8 flex flex-col items-center gap-4 animate-in fade-in-50 slide-in-from-bottom-10 duration-1000 delay-600">
          <div className="p-6 rounded-2xl bg-gradient-to-br from-blue-50/80 to-cyan-50/80 dark:from-blue-900/20 dark:to-cyan-900/20 backdrop-blur-sm border border-blue-200/50 dark:border-blue-800/50">
            ...
            <div className="flex gap-4">
              <Button asChild size="lg" className="bg-gradient-to-r from-blue-600 to-cyan-600 hover:from-blue-700 hover:to-cyan-700 text-white shadow-lg hover:shadow-xl transition-all duration-300 transform hover:scale-105">
                <Link href="/signup">Get Started</Link>
              </Button>
              <Button variant="outline" size="lg" asChild className="border-blue-300 text-blue-700 hover:bg-blue-50 dark:border-blue-700 dark:text-blue-300 dark:hover:bg-blue-900/20 transition-all duration-300">
